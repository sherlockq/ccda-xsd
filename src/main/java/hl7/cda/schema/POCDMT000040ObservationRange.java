 ...
 *         &lt;element ref="{urn:hl7-org:sdtc}precondition1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class POCDMT000040ObservationRange {
    ...
    protected List<Precondition1> precondition1;
    ...
    /**
     * Gets the value of the precondition1 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the precondition1 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrecondition1().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Precondition1> getPrecondition1() {
        if (precondition1 == null) {
            precondition1 = new ArrayList<Precondition1>();
        }
        return this.precondition1;
    }
